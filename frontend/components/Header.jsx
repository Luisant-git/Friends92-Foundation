          ...
          <div className="hidden md:flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <MdMail className="w-4 h-4 text-green-600" />
            ...
            <div className="flex justify-center items-center gap-4 pt-1">
              <FaFacebookF className="w-4 h-4 text-green-600 hover:text-green-700" />
              <FaInstagram className="w-4 h-4 text-green-600 hover:text-green-700" />
              <FaTwitter className="w-4 h-4 text-green-600 hover:text-green-700" />
              <FaLinkedinIn className="w-4 h-4 text-green-600 hover:text-green-700" />
            </div>
          </div>

          {/* Mobile */}
          <div className="md:hidden flex flex-col items-center justify-center text-center space-y-1 pt-2">
            {/* Email */}
            <div className="flex flex-wrap items-center justify-center gap-2">
              <MdMail className="w-4 h-4 text-green-600 flex-shrink-0" />
              <span className="text-sm">friends92foundation@gmail.com</span>
            </div>

            {/* Phone */}
            <div className="flex flex-wrap items-center justify-center gap-2">
              <MdPhone className="w-4 h-4 text-green-600 flex-shrink-0" />
