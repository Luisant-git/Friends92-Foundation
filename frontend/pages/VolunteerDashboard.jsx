    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-800 font-heading">{stats.totalTasks}</h3>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm font-body">Completed</p>
              <h3 className="text-3xl font-bold text-gray-800 font-heading">{stats.completedTasks}</h3>
            </div>
            <div className="bg-secondary/10 p-3 rounded-full">
              <svg className="w-8 h-8 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm font-body">Pending Tasks</p>
              <h3 className="text-3xl font-bold text-gray-800 font-heading">{stats.pendingTasks}</h3>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm font-body">Verified Tasks</p>
              <h3 className="text-3xl font-bold text-gray-800 font-heading">{stats.verifiedTasks}</h3>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-10 gap-6 mb-6">
        <div className="md:col-span-3 bg-white rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold mb-4 font-heading">Task Verified Progress</h2>
        ...
        <div className="md:col-span-7 bg-white rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold mb-4 font-heading">Task Timeline</h2>
            ...
            {tasks.slice(0, 5).map((task, index) => {
              ...
              return (
                <div key={task.id} className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-xs text-gray-600 text-center w-20 truncate font-body">{task.title}</p>
                </div>
              );
            })}
          </div>
