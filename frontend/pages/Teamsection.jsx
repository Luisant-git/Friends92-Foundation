    ...
    <section className="py-16">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Organizations that trust and support us.</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 max-w-7xl mx-auto">
          {trustLogos.map((partner, index) => (
            <div key={index} className="bg-white p-8 rounded-lg shadow-md flex flex-col items-center justify-center hover:shadow-xl transition">
