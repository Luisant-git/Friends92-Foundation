          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                {/* Address */}
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 hover:shadow-xl transition-all">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed font-body">
                        GPTCK 92 Trust (Alumni Foundation)
                        <br />
                        No.3/153, A3, R.N. Complex, Azad Nagar
                        <br />
                        Venkatapuram, Bynapalli Village
                        <br />
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 font-body">
                        <span className="block">+91 97500 89000</span>
                        <span className="block">+91 72008 68392</span>
                        <span className="block">+91 70108 36510</span>
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary mb-4 font-heading">Find Us</h2>
            <p className="text-gray-600 font-body">
