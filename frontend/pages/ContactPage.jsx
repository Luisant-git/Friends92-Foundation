    ...
    <div className="bg-white">
      ...
      <section className="bg-slate-700 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100">Get in touch with us - We're here to help</p>
        </div>
      </section>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        <span className="block">Emergency: +91 98765 43211</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <span className="block">General: friends92foundation@gmail.com</span>
                        <span className="block">Support: support@friends92foundation.org</span>
                        <span className="block">Donations: donate@friends92foundation.org</span>
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        <span className="block text-sm text-green-600 mt-2">Emergency services available 24/7</span>
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Visit our office or reach out to us through any of the channels above</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="h-96 bg-gray-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">123 Community Center Road, Sector 15, New Delhi</p>
              </div>
            </div>
          </div>
        </div>
