    ...
    <div className="bg-white">
      ...
      <section className="bg-primary text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 font-body">Making a Difference Through Action</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-primary sm:text-4xl mb-4 font-heading">Core Initiatives</h2>
            <p className="text-gray-600 max-w-2xl mx-auto font-body">Our comprehensive programs address the most pressing challenges in our communities through targeted interventions and sustainable solutions.</p>
          </div>
            ...
            {programs.map((program) => (
              <div key={program.id} className="bg-white rounded-xl border border-gray-200 shadow-lg p-6 hover:shadow-xl transition">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 font-heading">{program.title}</h3>
                </div>
                <p className="text-gray-700 mb-4 leading-relaxed font-body">{program.description}</p>
                <div className="bg-primary/5 border-l-4 border-primary p-4">
                  <p className="text-gray-700 text-sm font-semibold font-body">{program.impact}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto font-body">Highlighting our key initiatives that are transforming lives across communities.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {realTimeImpact.map((item) => (
              <div key={item.id} className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden hover:shadow-xl transition">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-3 font-heading">{item.title}</h3>
                  <div className="bg-secondary/5 border-l-4 border-secondary p-4">
                    <p className="text-secondary font-bold text-2xl mb-3 font-body">{item.metric}</p>
                    <p className="text-gray-600 text-sm leading-relaxed font-body">{item.impact}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-primary mb-6 font-heading">Get Involved</h2>
